...
const CategoriesWidget = () => {
  const [expensesByCategoriesDto, setExpensesByCategoriesDto] = useState<
    ExpenseCategoryWidgetDataProps[]
  >([]);
  ...
  useEffect(() => {
    ...
    api.sendRequest("GET", "/api/v1/dashboard/category-expenses", {
      onSuccessFunction: onSuccessFetchExpensesByCategories,
    });
        ...
        <Card className="p-4 flex flex-col gap-2 items-start justify-center w-full">
          ...
          <div className="flex flex-col gap-2 w-full">
            <div className="flex flex-col w-full justify-start items-start gap-4">
              <p className="text-sm">
                Create expenses to be able to see this widget
              </p>
              <div className="w-1/2">
                <AddExpenseModal
                  variant="default"
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-2">
      {expensesByCategoriesDto.map(
        (category: ExpenseCategoryWidgetDataProps) => (
          <Card
            key={category.id}
            className="p-4 flex flex-col gap-2 items-start justify-center w-full"
          >
            <div className="flex flex-row justify-start gap-2">
